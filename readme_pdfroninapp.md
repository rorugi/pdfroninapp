...
PDFronin is a fast, lightweight PDF reader and light-touch editor for Windows. It opens documents instantly, scrolls and zooms without stutter even on large files, and gives you the everyday tools you actually need — highlight, underline, strike-through, sticky notes, free text, ink, stamps, images, page deletion, merge, search, OCR, and printing — without burying them under a paywall or a browser-style UI.

## Why we built it

Most PDF programs on Windows fall into two camps: heavy commercial suites that are slow, spammy, and push cloud sign-ins, or minimalist viewers that can't really edit. At a university — where you read dozens of lecture scripts, papers, scanned handouts and exam drafts every week — neither is a good fit. You want to pull up a 400-page course reader in a second, highlight a passage while the lecturer is still talking, add a sticky note before your brain forgets the idea, and move on. Later you want to delete the cover pages, merge two handouts, OCR a scanned chapter, and print a clean copy for the exam — all without a subscription, an account, or a round-trip through someone's cloud.
...
It's intentionally not a replacement for professional PDF production tools. It's the reader and everyday annotator we wanted on our own machines for reading, studying, marking up and printing — so we wrote it.
